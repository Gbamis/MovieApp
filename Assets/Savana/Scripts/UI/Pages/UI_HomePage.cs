...
namespace Savana.Movie
{
    ...
    public class UI_HomePage : MonoBehaviour, UIState
    {
        ...
        public void Enter()
        {
            ...
            {
                nowTrendingPanel.Show();
            }
            nowTrendingPanel.PopulateListViewWithMovieItems(_controller);
        ...
        private void SearchClicked()
        {
            ...
            searchPanel.Show();
            searchPanel.Search(query, () => nowTrendingPanel.Show(), SuccesfulSearch, FailedSearch, _controller);
        }
